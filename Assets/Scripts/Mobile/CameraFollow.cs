...
public class CameraFollow : MonoBehaviour {
    ...
    private void EvaluateFocus()
    {
		...
		if (PointsOfInterest.Count > 0 && bPOI == true) {
			...
			foreach (Transform t in PointsOfInterest) {
				if (t == null)
					Debug.LogError ("There is a missing POI");
		...
		else if (POIOffset != Vector2.zero) {
			POIOffset = Vector2.zero;
        }
    ...
    public void FollowCam()
    {
        ...
        //{
            ...
            //trans.position = Position;
            // TODO: Figure out why there is that initial offset when the camera is not following anything.
            // Probably worth setting the camera to change function that it uses based on whether it is following or not.
            // You know you want to try the function cacheing thing - it'll be fun.
            //SmoothTransition();
        //}
        //catch (System.Exception e)
        //{
